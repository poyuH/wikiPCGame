...
if __name__ == '__main__':
    ...
    # crawl_game_wikiList('https://en.wikipedia.org/wiki/List_of_PC_games_(Numerical)', save=True)
    # for char in 'R':
        # crawl_game_wikiList('https://en.wikipedia.org/wiki/List_of_PC_games_('+ char + ')', save=True)
